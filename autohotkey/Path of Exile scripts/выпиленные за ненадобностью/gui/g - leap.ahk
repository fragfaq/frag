...
;Gui, Add, Text, x7 y37 w240 h150 c%vc9% BackgroundTrans, Leap
;Gui, Add, Text, x2 y30 w240 h150 c%vc11% BackgroundTrans, Leap
;окно и прозрачность

Gui, Font, S30 Bold, Tahoma ;тайтл
Gui, Add, Text, x93 y-1 w240 h50 c%vc4% BackgroundTrans, Leap
Gui, Add, Text, x90 y-5 w240 h50 c%vc7% BackgroundTrans, Leap
;окно и прозрачность

Gui, Show, x310 y930 h140 w250, Leap
Gui, Color, 000001
