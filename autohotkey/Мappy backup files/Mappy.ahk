...
; ================== Added by FRAG ==========================
Menu, Tray, Icon, %A_ScriptDir%\images\icon.ico, 1
; ===========================================================
...
; ================== Added by FRAG ==========================
Gui, +ToolWindow ; Окно не будет иметь кнопки на панели задач
Gui, Font, S11 W700, Verdana
; ===========================================================
...
; ================== Commented by FRAG ======================
; Я закомментировал 3 строчки, отвечающие за Settings, New и Load Overlay, т.к. после
; Настройки они будут только мешаться, при необходимости всегда можно вернуть их на место.
