...
; Тут мы прописываем настройки Gui без -SysMenu, что бы отображались виндовские кнопки закрыть и скрыть.
Gui, %GUINameMappy%:New, +LastFound +AlwaysOnTop, %GUINameMappy% - Version %CurrentVersion% - %ConfigFileName%
Gui, %GUINameMappy%:Color, %CustomColor%
WinSet, TransColor, %CustomColor% %Transparency%
; ================== Added by FRAG ==========================
; Gui, +ToolWindow 
; Окно не будет иметь кнопки на панели задач если раскомитить
Gui, Font, S11 W600, Verdana
; Увеличиваем размер шрифтта, что б не ослепнуть
; ===========================================================
; Gui, Add, Button, x10 y5 gLock, Lock Menu
; Отключаем кнопку Lock Menu, что бы свободно двигать окном
...
; ================== Commented by FRAG ======================
; Следующие 3 строчки, отвечающие за Settings, New и Load Overlay можно закомментировать т.к. после настройки они могут мешаться, при необходимости всегда можно вернуть их на место.
